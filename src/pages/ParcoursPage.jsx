function ParcoursPage() {
  const parcours = [
    ...
    },
    {
      ...
      details:
        "Recherche concurrentielle sur des sites de marketing digital, développement/déploiement d'un site WordPress et optimisation SEO + lisibilité des contenus.",
      statut: 'Stage',
    },
    {
